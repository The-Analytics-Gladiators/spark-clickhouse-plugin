...
case class ClickhouseUInt32(nullable: Boolean, lowCardinality: Boolean)
  ...
  override def setValueToStatement(i: Int, value: Long, statement: PreparedStatement)(clickhouseTimeZoneInfo: ClickhouseTimeZoneInfo): Unit =
